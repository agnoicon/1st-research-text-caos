...
\begin{figure}[htb!]
{\centering {\includegraphics[width=120mm,height=35mm]{input.pdf}}\par}
...
The first approach in searching for the optimum was done through an exhaustive search technique. Even though it implies a lot of search time, it is guaranteed that the optimum will be found, as stated in Section ~\ref{sssec:exh}.
...
\begin{figure}[htb!]
{\centering {\includegraphics[width=115mm,height=38mm]{as_pipeline.pdf}}\par}
...
\begin{figure}[htb!]
{\centering {\includegraphics[width=130mm,height=42mm]{3d_woorder.pdf}}\par}
...
\begin{figure}[htb!]
{\centering {\includegraphics[width=130mm,height=42mm]{3d_ordered.pdf}}\par}
...
\begin{figure}[htb!]
{\centering {\includegraphics[width=130mm,height=42mm]{ordered_tpipe_pm3d_contour.pdf}}\par}
...
\begin{minipage}[t][1\totalheight][s]{1\columnwidth}%
 %
\noindent \begin{center}
\centering{\includegraphics[scale=0.4]{figs4/v0/6400-602-25-exh-LoS-min.png}}
\par\end{center}
...
% 1st Workload Scenario  ! WELL up to here !!
...
regions found by the AP method. In such
...
\clearpage
% 2nd Workload Scenario  ! WELL up to here !!

% 3rd Workload Scenario
...
\clearpage
% 3rd Workload Scenario   OK up to here !! 02/06/2014

% 4th Workload Scenario
